...
def _color_for(palette, material_key: str) -> tuple[int, int, int]:
    ...
    mapping = {
        ...
        "door_panel": (70, 45, 30),
        "magasin_door_panel": (58, 38, 25),
        "magasin_door_dark": (50, 34, 24),
        "magasin_door_weathered": (93, 70, 50),
        "magasin_door_ochre": (122, 82, 46),
        "magasin_trim": (31, 25, 20),
        "magasin_trim_dark": (32, 25, 20),
        "magasin_trim_brown": (62, 43, 29),
        "magasin_trim_aged": (96, 78, 58),
        "magasin_shutter": (104, 74, 48),
        "magasin_shutter_warm": (118, 77, 43),
        "magasin_shutter_dark": (56, 42, 31),
        "magasin_shutter_faded": (126, 103, 74),
        "magasin_sign": (92, 56, 33),
        "magasin_sign_umber": (92, 56, 33),
        "magasin_sign_green": (54, 82, 62),
        "magasin_sign_slate": (75, 82, 88),
        "magasin_sign_ochre": (128, 92, 46),
        "magasin_canvas": (112, 88, 58),
        "magasin_canvas_tan": (139, 112, 77),
        "magasin_canvas_grey": (120, 118, 108),
        "magasin_canvas_olive": (106, 111, 77),
        "chimney_brick": (146, 72, 55),
        "monument_stone": (194, 181, 154),
        ...
        "fountain_stone_dark": (112, 103, 88),
        "fountain_basin_stone": (184, 173, 151),
        ...
        "grass_ground": (112, 139, 78),
        "grass_light": (132, 164, 88),
        "grass_dark": (76, 113, 58),
        "garden_shrub": (86, 126, 62),
        "tree_canopy": (58, 104, 48),
        "tree_canopy_light": (86, 134, 61),
        "tree_canopy_dark": (38, 82, 39),
        "tree_trunk": (88, 55, 34),
        "tree_bark_dark": (58, 38, 27),
