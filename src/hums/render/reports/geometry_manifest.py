    ...
    for mesh in scene.buildings:
        ...
        if "window_glass" in roof_materials and material == "glass_roof":
            ...
            if clocher_top and clocher_src:
                note = "special church roof: low tile body, curved lead/zinc kubbe with 3 arched glazed eyes"
                ...
                note = "special church roof: low tile body, curved lead/zinc kubbe, clocher"
